...
import com.example.tubes.komediNovel.GridNovelKomediAdapter;
import com.example.tubes.komediNovel.KomediModels;

import java.util.ArrayList;

public class GridNovelKomediAdapter extends RecyclerView.Adapter<GridNovelKomediAdapter.ViewHolder> {
    private ArrayList<KomediModels> dataKlmp;
    private Context context;

    GridNovelKomediAdapter(ArrayList<KomediModels>dataKlmp, Context context ){
    ...
    public GridNovelKomediAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull GridNovelKomediAdapter.ViewHolder holder, int position) {
