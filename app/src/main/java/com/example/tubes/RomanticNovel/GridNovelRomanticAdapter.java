...
import com.example.tubes.RomanticNovel.GridNovelRomanticAdapter;
import com.example.tubes.RomanticNovel.NovelModel;

import java.util.ArrayList;

public class GridNovelRomanticAdapter extends RecyclerView.Adapter<GridNovelRomanticAdapter.ViewHolder> {
    private ArrayList<NovelModel> dataKlmp;
    private Context context;

    GridNovelRomanticAdapter(ArrayList<NovelModel>dataKlmp, Context context ){
    ...
    @Override
    public void onBindViewHolder(@NonNull GridNovelRomanticAdapter.ViewHolder holder, int position) {
